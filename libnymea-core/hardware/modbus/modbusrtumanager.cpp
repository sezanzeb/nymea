    ...
    m_serialPortMonitor(serialPortMonitor)
{
    ...
    connect(m_serialPortMonitor, &SerialPortMonitor::serialPortAdded, this, &ModbusRtuManager::onSerialPortRemoved);
...
void ModbusRtuManager::loadPlatformConfiguration()
{
    ...
    if (platformConfigurationFileInfo.exists()) {
        ...
        /* Example configuration: /etc/nymea/modbus-rtu-platform.conf
